...
class TD3(BaseController):
    ...
    def __init__(self,
        ...
        # agent
        self.agent = TD3Agent(self.env.observation_space,
    ...
    def reset(self):
        ...
        if self.training:
            ...
            self.buffer = TD3Buffer(self.env.observation_space, self.env.action_space, self.max_buffer_size, self.train_batch_size)
        else:
            # set up stats tracking
            self.env.add_tracker('constraint_violation', 0, mode='queue')
