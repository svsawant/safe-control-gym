"""Soft Actor Critic (SAC) with QMPC"""
...
from safe_control_gym.controllers.sac_mpc.sac_qmpc_utils import (
    SAC_QMPC_Agent,
    SACBuffer,
)
...
class SAC_QMPC(BaseController):
    """Soft Actor Critic with QMPC"""
